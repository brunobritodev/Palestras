...
namespace ClientCredentials.Financeiro.AcessoLeitura
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var tokenResponse = await client.RequestClientCredentialsTokenAsync(new ClientCredentialsTokenRequest
            {
                ...
                ClientId = "vssummit-client-credentials-leitura",
                ClientSecret = "senha-leitura",
                Scope = "vssummit-financeiro.leitura"
            });
